...
@Data
public class GoHighLevelPostCreateRequest {
    ...
    public static GoHighLevelPostCreateRequest fromRequest(PostCreateRequest request) {
        GoHighLevelPostCreateRequest ghl = new GoHighLevelPostCreateRequest();
