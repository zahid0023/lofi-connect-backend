...
public class GoHighLevelContactCreateRequest {
    ...
    private GoHighLevelContactCreateRequest() {

    }

    /**
     * Converts ContactCreateRequest -> GoHighLevelContactUpsertRequest using ObjectMapper.
     */
    public static GoHighLevelContactCreateRequest fromRequest(ContactCreateRequest request, ObjectMapper objectMapper) {
        GoHighLevelContactCreateRequest ghl = objectMapper.convertValue(request, GoHighLevelContactCreateRequest.class);
