...
@Data
public class GoHighLevelProductCreateRequest {
    private String name;
    ...
    public static GoHighLevelProductCreateRequest fromRequest(ProductCreateRequest request) {
        GoHighLevelProductCreateRequest ghl = new GoHighLevelProductCreateRequest();
