...
@Data
public class GoHighLevelPriceCreateRequest {
    private String name;
    private String type;
    private String currency;
    private Double amount;
    private PriceCreateRequest.Recurring recurring;
    private String description;
    private List<PriceCreateRequest.MembershipOffer> membershipOffers;
    ...
    private PriceCreateRequest.Meta meta;
    private Boolean trackInventory;
    private Integer availableQuantity;
    private Boolean allowOutOfStockPurchases;
    private String sku;
    private PriceCreateRequest.ShippingOptions shippingOptions;
    private Boolean isDigitalProduct;
    private List<String> digitalDelivery;

    public static GoHighLevelPriceCreateRequest fromRequest(PriceCreateRequest request) {
        GoHighLevelPriceCreateRequest ghl = new GoHighLevelPriceCreateRequest();
