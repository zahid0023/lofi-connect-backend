...
@Data
public class GoHighLevelShippingZoneRateCreateRequest {
    ...
    public static GoHighLevelShippingZoneRateCreateRequest fromRequest(ShippingZoneRateCreateRequest request) {
        GoHighLevelShippingZoneRateCreateRequest ghl = new GoHighLevelShippingZoneRateCreateRequest();
