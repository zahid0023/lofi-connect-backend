...
@Data
public class GoHighLevelShippingZoneCreateRequest {
    ...
    public static GoHighLevelShippingZoneCreateRequest fromRequest(ShippingZoneCreateRequest request) {
        GoHighLevelShippingZoneCreateRequest ghlRequest = new GoHighLevelShippingZoneCreateRequest();
