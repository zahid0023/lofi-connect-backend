...
import lombok.Data;
import org.example.loficonnect.dto.request.estimate.EstimateTemplateUpdateRequest;

import java.util.ArrayList;
import java.util.List;

@Data
public class GoHighLevelEstimateTemplateUpdateRequest {
    ...
    public static GoHighLevelEstimateTemplateUpdateRequest fromRequest(EstimateTemplateUpdateRequest request) {
        GoHighLevelEstimateTemplateUpdateRequest ghlRequest = new GoHighLevelEstimateTemplateUpdateRequest();
        ...
        if (request.getItems() != null && !request.getItems().isEmpty()) {
            ...
            for (EstimateTemplateUpdateRequest.Item item : request.getItems()) {
        ...
        if (request.getAttachments() != null && !request.getAttachments().isEmpty()) {
            ...
            for (EstimateTemplateUpdateRequest.Attachment attachment : request.getAttachments()) {
