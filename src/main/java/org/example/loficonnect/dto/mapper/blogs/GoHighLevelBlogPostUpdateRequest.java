...
@Data
public class GoHighLevelBlogPostUpdateRequest {
    ...
    public static GoHighLevelBlogPostUpdateRequest fromRequest(BlogPostUpdateRequest request) {
        GoHighLevelBlogPostUpdateRequest ghl = new GoHighLevelBlogPostUpdateRequest();
