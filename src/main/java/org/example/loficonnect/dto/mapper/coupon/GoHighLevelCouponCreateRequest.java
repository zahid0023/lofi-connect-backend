...
@Data
public class GoHighLevelCouponCreateRequest {
    ...
    public static GoHighLevelCouponCreateRequest fromRequest(CouponCreateRequest request) {
        GoHighLevelCouponCreateRequest ghl = new GoHighLevelCouponCreateRequest();
