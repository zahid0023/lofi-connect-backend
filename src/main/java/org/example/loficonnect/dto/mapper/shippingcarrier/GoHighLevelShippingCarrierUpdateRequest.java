...
@Data
public class GoHighLevelShippingCarrierUpdateRequest {
    ...
    public static GoHighLevelShippingCarrierUpdateRequest fromRequest(ShippingCarrierUpdateRequest request) {
        GoHighLevelShippingCarrierUpdateRequest ghlRequest = new GoHighLevelShippingCarrierUpdateRequest();
