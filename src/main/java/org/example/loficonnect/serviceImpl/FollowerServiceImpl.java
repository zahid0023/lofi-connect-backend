...
public class FollowerServiceImpl implements FollowerService {
    ...
    public FollowerServiceImpl(AuthorizationService authorizationService, FollowerClient followerClient) {
    ...
    public JsonNode addFollowers(String contactId, AddFollowersRequest request) {
        ...
        GoHighLevelAddFollowersRequest ghlRequest = GoHighLevelAddFollowersRequest.fromRequest(request);
    ...
    public JsonNode removeFollowers(String contactId, RemoveFollowersRequest request) {
        String accessKey = authorizationService.getAccessToken(AppKeyContext.getAppKey());
        String version = VersionContext.getVersion();
        GoHighLevelRemoveFollowersRequest ghlRequest = GoHighLevelRemoveFollowersRequest.fromRequest(request);
